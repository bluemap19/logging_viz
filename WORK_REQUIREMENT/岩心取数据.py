...
if __name__ == '__main__':
    # path_core_data = r'F:\logging_workspace\塬22\塬22-岩心矿物含量.csv'
    # path_core_data = r'F:\logging_workspace\塬22\塬22-岩心矿物含量.csv'
    path_core_data = r'F:\logging_workspace\姬119H2\姬119H2导眼井全岩实验数据.csv'
    ...
    # 常规测井数据读取
    data_logging = data_well.get_logging(key=r'F:\logging_workspace\姬119H2\姬119H2井-常规测井_logging.csv')
    ...
    for i in range(data_core.shape[0]):
        ...
        data_temp = data_well.get_logging(key=r'F:\logging_workspace\姬119H2\姬119H2井-常规测井_logging.csv', depth_limit=[depth_point-0.05, depth_point+0.05])
    ...
    data_core.to_excel(path_well + r'\姬119H2-岩心总数据.xlsx', index=False, sheet_name='0')
    ...
    #     df_input=data_core,
    #     target_col='铁矿物含量',
    #     input_cols=['WAVELET_FMI', 'KMEANS_FMI', 'OTSU_FMI', 'ADAPTIVE_FMI', 'TOPHAT_OTSU_FMI', 'GMM_FMI', 'MIX_FMI'],
    #     regressor_use=True,
    #     replace_dict={}
    # )
